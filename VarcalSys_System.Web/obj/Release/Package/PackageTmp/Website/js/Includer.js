...
///// include js files ////////////
$.include('/Website/js/cufon/FrancophilSans_500-FrancophilSans_700.font.js');
$.include('/WebSite/js/jquery.easing.1.3.js');

	// Dropdown Menu Plugin
	if (jQuery(".ddsmoothmenu").length) {
		$.include('/Website/js/ddsmoothmenu.js');
	}

	// jQuery flexible columns
	if (jQuery("#fsb, .column").length) {
		$.include('/Website/js/jquery.flexibleColumns.min.js');
		jQuery(function(){
...
// ========================================= Sliders ===================================================
	...
	if (jQuery("#accordion").length) {
		$.include('/Website/sliders/accordion-slider/jquery.elegantAccordion.js');
	...
	if (jQuery("#nivo-slider").length) {
		$.include('/Website/sliders/nivo-slider/jquery.nivo.slider.js');
		jQuery(document).ready(function(){
	...
	if (jQuery("#coin-slider").length) {
		$.include('/Website/sliders/coin-slider/coin-slider.js');
		jQuery(document).ready(function(){
	...
	if (jQuery("#anything").length) {
		$.include('/Website/sliders/anything-slider/jquery.anythingslider.js');
		jQuery(document).ready(function(){
			jQuery('#anything')
			  .anythingSlider({
			   width        : 952,
	...
	if (jQuery("#piecemaker").length) {
      $.include('/Website/piecemaker/scripts/swfobject/swfobject.js');
		jQuery(document).ready(function(){
			var flashvars = {};
			flashvars.cssSource = "/Website/piecemaker/piecemaker.css";
			flashvars.xmlSource = "/Website/piecemaker/piecemaker.xml";
			var params = {};
			params.play = "true";
			params.menu = "false";
			...
			swfobject.embedSWF('/Website/piecemaker/piecemaker.swf', 'piecemaker', '1000', '600', '10', null, flashvars,    
			params, null);
		});
	}
	...
	if (jQuery("#orbit-slider").length) {
		$.include('/Website/sliders/orbit-slider/jquery.orbit.js');
		jQuery(document).ready(function(){
			jQuery('#orbit-slider').orbit({
				 ...
				 bulletThumbLocation: '~/Website/sliders/orbit-slider/orbit/',		// location from this file where thumbs will be
	...
	if (jQuery("#s3slider").length) {
		$.include('/Website/sliders/serie3-slider/s3Slider.js');
		jQuery(document).ready(function(){
	...
	if (jQuery("#roundabout").length) {
		$.include('/Website/sliders/roundabout-slider/jquery.roundabout.min.js');
		$.include('/Website/sliders/roundabout-slider/jquery.roundabout-shapes.min.js');
		jQuery(document).ready(function(){
	...
	if (jQuery(".widget_recent_projects").length) {
		$.include('/Website/js/jquery.cycle.all.min.js');
		jQuery(function(){
	...
	if (jQuery("a[data-rel^='prettyPhoto']").length) {
		$.include('/Website/js/jquery.prettyPhoto.js');
	}

	// jQuery Tinycarousel
	if (jQuery("#slider-code").length) {
		$.include('/Website/js/jquery.tinycarousel.js');
		jQuery(document).ready(function(){
	...
	if (jQuery(".social").length) {
		$.include('/Website/js/jquery.tipsy.js');
	}

	// jQuery Watermark Plugin
	if (jQuery(".widget_search").length) {
		$.include('/Website/js/jquery.watermarkinput.js');
	}

	if (jQuery(".gototop").length) {
		$.include('/Website/js/jquery.localscroll-min.js');
		$.include('/Website/js/jquery.scrollTo-min.js');
	}
	
	// Contact Form Plugin
	if (jQuery("#contact").length) {
		$.include('/Website/js/jquery.jigowatt.js');
	}

	// jQuery Uniform Plugin
	if (jQuery("select, input:checkbox, input:radio").length) {
		$.include('/Website/js/jquery.uniform.min.js');
	}
